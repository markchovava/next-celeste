...
import { IoIosPricetags, IoMdRemoveCircleOutline } from "react-icons/io";
import { 
    FaAngleLeft, 
    FaUpload, FaRegHandshake, FaTiktok, FaLinkedin, FaXTwitter } from "react-icons/fa6";
...
export default function IconDefault({
    ...
    switch(type) {
        case 'solar-roof':
            return (
                <PiSolarRoofDuotone className={css} />
            )
        case 'solar-power':
            return (
                <TbSolarElectricity className={css} />
            )
        case 'solar':
            return (
                <TbSolarPanel2 className={css} />
            )
        case 'star':
            return (
                <FaRegStar className={css} />
            )
        case 'email':
            return (
